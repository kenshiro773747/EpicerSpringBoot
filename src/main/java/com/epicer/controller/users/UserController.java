...
public class UserController {
	...
	public ResponseEntity<String> vertifyAccount(Model m){
...
//	@PostMapping(path="/userdownload")
//	public void downloadPdf(HttpServletResponse response,HttpServletRequest request) throws Exception {
//        User user = (User)m.addAttribute("user");
//        System.out.println(user.getAccount());
//		String str = request.getParameter("userid");
//		int id = Integer.parseInt(str);
//		System.out.println(str+"000");
//		System.out.println(id+"111");
//		EpicerUser user = login.selectById(id);
