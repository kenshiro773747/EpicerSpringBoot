        ...
        <div class="block text-center">
          ...
          <form class="text-left clearfix" action="vertifymail" method="post">
            ...
            <div class="text-center">
              <button type="submit" name="chose" id="commit" class="btn btn-main text-center" value="送出" disabled>送出</button>
              <button type="submit" name="chose" id="commit2" class="btn btn-main text-center" value="返回" disabled>返回</button>
            </div>
