...
大家串聯在這，最最後要討論串連的地方///// -->
	...
	Course theCourse = (Course) request.getAttribute("courseWithId");
	%>
			...
			<div class="row mt-20">
							...
							<div class='carousel-outer'>
								...
								<div class='carousel-inner '>
									...
									<img width=500 height=300
										src="images/<%=theCourse.getCourseImage()%>" />
				...
				<div class="col-md-7">
					<div class="single-product-details">
						<h2><%=theCourse.getCourseName()%></h2>
						<p class="product-price">
							$<%=theCourse.getCoursePrice()%></p>

						<p class="product-description mt-20">
							<%=theCourse.getCourseDescription()%>
						</p>
						...
						<div class="product-category">
							...
							<ul>
								<li><a href="/555">Course</a></li>
								<!--  <li><a href="product-single.html"theCourse.getCourseStyle()e() %></li>-->
							</ul>
						</div>
					...
					<div class="tabCommon mt-20">
						...
						<div class="tab-content patternbg">
							<div id="details" class="tab-pane fade active in">
								<h4>課程描述</h4>
								<p><%=theCourse.getCourseckeditor()%></p>
							</div>
								...
								<div class="post-comments">
									<ul class="media-list comments-list m-bot-50 clearlist">
										...
										<li class="media"><a class="pull-left" href="#!"> <img
												...
												src="./source/images/blog/avater-1.jpg" alt="" width="50"
												height="50" />
										</a>
										...
										<li class="media"><a class="pull-left" href="#!"> <img
												class="media-object comment-avatar"
												src="./source/images/blog/avater-4.jpg" alt="" width="50"
												height="50" />
										</a>
									...
									<form action="/999" method="post">
										...
										<li>
												...
												<span data-toggle="modal" data-target="#product-modal">
													<button type="submit"><i class="tf-ion-ios-search"></i></button>
												</span>
